...
export const WhatIfSimulator: React.FC<WhatIfSimulatorProps> = ({ onReoptimized }) => {
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800 rounded-xl overflow-hidden shadow-lg p-4 sm:p-6">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6 border-b border-slate-800 pb-4">
        <div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-red-600 hover:bg-red-500 text-white font-semibold text-xs transition-all shadow-lg shadow-red-600/20 disabled:opacity-50 w-full sm:w-auto"
          >
      ...
      {result ? (
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-3.5 sm:p-4">
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-3.5 sm:p-4">
              ...
              <span className="text-lg sm:text-xl font-bold text-white font-mono">{result.changes_count}</span>
                ...
                {result.schedule_diffs.map((diff, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between sm:justify-start gap-2 font-mono text-[11px] shrink-0 bg-slate-900/80 px-3 py-1.5 rounded-lg border border-slate-800 w-full sm:w-auto">
        ...
        <div className="text-center py-12 sm:py-16 text-slate-400 text-sm bg-slate-950/40 rounded-xl border border-slate-800/80 px-4">
